          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="hidden lg:flex items-center gap-4">
                <motion.a href="https://www.facebook.com/battelpro.pvcpatches" whileHover={{ scale: 1.2 }} className="text-gray-400 hover:text-primary transition-colors">
                ...
                <motion.a href="https://www.instagram.com/p/DZ7CmVVjpem/?igsh=cDcydzdya2lmYWVk&igsi=cDcydzdya2lmYWVk" target="_blank" rel="noopener noreferrer" aria-label="Instagram" whileHover={{ scale: 1.2 }} className="text-gray-400 hover:text-primary transition-colors">
